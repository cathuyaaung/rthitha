...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.location4'
        db.add_column(u'zmovies_movie', 'location4',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.location5'
        db.add_column(u'zmovies_movie', 'location5',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.location6'
        db.add_column(u'zmovies_movie', 'location6',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.location7'
        db.add_column(u'zmovies_movie', 'location7',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.location8'
        db.add_column(u'zmovies_movie', 'location8',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.location9'
        db.add_column(u'zmovies_movie', 'location9',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.location10'
        db.add_column(u'zmovies_movie', 'location10',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.location4'
        db.delete_column(u'zmovies_movie', 'location4')

        # Deleting field 'Movie.location5'
        db.delete_column(u'zmovies_movie', 'location5')

        # Deleting field 'Movie.location6'
        db.delete_column(u'zmovies_movie', 'location6')

        # Deleting field 'Movie.location7'
        db.delete_column(u'zmovies_movie', 'location7')

        # Deleting field 'Movie.location8'
        db.delete_column(u'zmovies_movie', 'location8')

        # Deleting field 'Movie.location9'
        db.delete_column(u'zmovies_movie', 'location9')

        # Deleting field 'Movie.location10'
        db.delete_column(u'zmovies_movie', 'location10')
    ...
    models = {
        ...
        u'zmovies.movie': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
