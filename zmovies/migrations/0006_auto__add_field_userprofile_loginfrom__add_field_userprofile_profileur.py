...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.loginfrom'
        db.add_column(u'zmovies_userprofile', 'loginfrom',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.profileurl'
        db.add_column(u'zmovies_userprofile', 'profileurl',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.loginfrom'
        db.delete_column(u'zmovies_userprofile', 'loginfrom')

        # Deleting field 'UserProfile.profileurl'
        db.delete_column(u'zmovies_userprofile', 'profileurl')
    ...
    models = {
        ...
        u'zmovies.movie': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
