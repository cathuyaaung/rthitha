...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.tomatourl'
        db.add_column(u'zmovies_movie', 'tomatourl',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.tomatourl'
        db.delete_column(u'zmovies_movie', 'tomatourl')
    ...
    models = {
        ...
        u'zmovies.movie': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 22, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 22, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
