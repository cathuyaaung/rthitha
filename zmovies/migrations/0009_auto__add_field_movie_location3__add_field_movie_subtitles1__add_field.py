...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.location3'
        db.add_column(u'zmovies_movie', 'location3',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.subtitles1'
        db.add_column(u'zmovies_movie', 'subtitles1',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.subtitles2'
        db.add_column(u'zmovies_movie', 'subtitles2',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie.location3'
        db.delete_column(u'zmovies_movie', 'location3')

        # Deleting field 'Movie.subtitles1'
        db.delete_column(u'zmovies_movie', 'subtitles1')

        # Deleting field 'Movie.subtitles2'
        db.delete_column(u'zmovies_movie', 'subtitles2')
